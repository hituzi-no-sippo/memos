...
:revnumber: v1.2.0
:revdate: 2021-12-14T05:49:50+0900
:revremark: `LspInstallInfo` のUIの表示を追加する
...
link:https://github.com/williamboman/nvim-lsp-installer/blob/8fab72f68391a2719b5ee7b399789d33e0a2d416/lua/nvim-lsp-installer.lua#L215-L223[
